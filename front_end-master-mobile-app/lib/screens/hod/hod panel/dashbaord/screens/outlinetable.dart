...
class _OutlineTableState extends State<OutlineTable> {
  ...
  final List<DataColumn> _columns = [
    ...
    const DataColumn(
        label: Text("Approve Outline"),
        tooltip: "Approve Outline Added in this lecture"),
    const DataColumn(
        label: Text("Reject Outline"),
        tooltip: "Reject Outline Added in this lecture"),
  ];
