...
import '../Objectives/widgets/objectivebtn.dart';
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: noOfWeeks.map((weeks) {
                          // final weeksAdded = lecController.myLecturesOutline
                          ...
                          //             .toLowerCase()
                          //             .replaceAll(RegExp(r"\(|\)"), "")))
                          //     .map((e) => e.weeks.toString());
                          // ;
                          // print("weeksAdded is ${weeksAdded.map((e) => e.toString())}");
                          // print("weeks = $weeks");
                          // if (weeksAdded.toString() == weeks.toString()) {}
                          return weeks == 8
